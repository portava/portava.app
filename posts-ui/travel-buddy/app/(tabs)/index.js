...
var RealPostsList_1 = require("../../src/components/RealPostsList");
...
function Pulse() {
    ...
    var Header = (<react_native_1.View>
      ...
      <RealPostsList_1.RealPostsList data={realFeed.data} loading={realFeed.loading} error={realFeed.error} onRetry={realFeed.reload}/>
