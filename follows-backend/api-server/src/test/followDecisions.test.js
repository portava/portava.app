...
var followDecisions_ts_1 = require("../lib/followDecisions.ts");
...
(0, node_test_1.test)("1. user can follow another existing user", function () {
    strict_1.default.deepEqual((0, followDecisions_ts_1.decideFollow)(A, B, { targetExists: true }), { ok: true });
});
(0, node_test_1.test)("2. unauthenticated cannot follow", function () {
    var d = (0, followDecisions_ts_1.decideFollow)(null, B, { targetExists: true });
...
(0, node_test_1.test)("3. cannot follow self", function () {
    var d = (0, followDecisions_ts_1.decideFollow)(A, A, { targetExists: true });
    strict_1.default.equal(d.ok, false);
    strict_1.default.equal(d.code, "cannot_follow_self");
});
(0, node_test_1.test)("4. cannot follow a non-existent user", function () {
    var d = (0, followDecisions_ts_1.decideFollow)(A, B, { targetExists: false });
    strict_1.default.equal(d.ok, false);
    strict_1.default.equal(d.code, "not_found");
});
(0, node_test_1.test)("5. invalid target id -> invalid_payload", function () {
    var d = (0, followDecisions_ts_1.decideFollow)(A, "not-a-uuid", { targetExists: true });
    strict_1.default.equal(d.ok, false);
    strict_1.default.equal(d.code, "invalid_payload");
});
(0, node_test_1.test)("6. blocked user cannot follow", function () {
    var d = (0, followDecisions_ts_1.decideFollow)(A, B, { targetExists: true, blocked: true });
    strict_1.default.equal(d.ok, false);
    strict_1.default.equal(d.code, "blocked");
});
(0, node_test_1.test)("7. unfollow requires auth", function () {
    strict_1.default.equal((0, followDecisions_ts_1.decideUnfollow)(null, B).ok, false);
    strict_1.default.deepEqual((0, followDecisions_ts_1.decideUnfollow)(A, B), { ok: true });
});
(0, node_test_1.test)("8. unfollow with bad target -> invalid_payload", function () {
    var d = (0, followDecisions_ts_1.decideUnfollow)(A, "nope");
    strict_1.default.equal(d.ok, false);
    strict_1.default.equal(d.code, "invalid_payload");
});
(0, node_test_1.test)("9. isUuid validates", function () {
    strict_1.default.equal((0, followDecisions_ts_1.isUuid)(A), true);
    strict_1.default.equal((0, followDecisions_ts_1.isUuid)("nope"), false);
});
...
(0, node_test_1.test)("10. decideFollow signature exposes no sensitive-access surface", function () {
    ...
    var d = (0, followDecisions_ts_1.decideFollow)(A, B, { targetExists: true });
