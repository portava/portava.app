...
| M11 | Layers / Legend | C | `src/components/map/LayersSheet.tsx:2`; opened at `app/map/index.tsx:3257#visible={overlayOpen('LAYERS')}`. |
...
| M268 | `plan_joined` | **W** | `src/features/map/telemetry/mapTelemetry.ts:652#'plan_joined',`; 2 emitters: `src/components/map/MapEntityActionRow.tsx:476#emitMapEvent('plan_joined',`, `app/map/index.tsx:408#emitMapEvent('plan_joined',`. |
| M269 | `meet_here_created` | **W** | `src/features/map/telemetry/mapTelemetry.ts:653#'meet_here_created',`; 1 emitter: `app/map/index.tsx:3169#emitMapEvent('meet_here_created',`. |
| M270 | `crew_locate_started` | **W** | `src/features/map/telemetry/mapTelemetry.ts:654#'crew_locate_started',`; 1 emitter: `app/map/index.tsx:2184#emitMapEvent('crew_locate_started',`. |
| M271 | `contribution_submitted` | **W** | `src/features/map/telemetry/mapTelemetry.ts:655#'contribution_submitted',`; 1 emitter: `app/map/index.tsx:2888#emitMapEvent('contribution_submitted',`. `src/features/map/telemetry/mapTelemetry.ts:585#sinceRouteStart` carries the banded time since `route_started`. |
| M272 | `alternative_requested` | **W** | `src/features/map/telemetry/mapTelemetry.ts:656#'alternative_requested',`; 1 emitter: `app/map/index.tsx:3190#emitMapEvent('alternative_requested',`. |
...
1. **`app/map/index.tsx:2851#emitMapEvent('why_shown_opened',` → use `whyShownOpenedPayload`.** Replace the inline
