...
**all NOT-BUILT.** The nearest artifact is `services/media/MediaProjectionService.ts:1296#{ key: "gems", label: "Hidden Gems", ownerOnly: false, count: gemsCount, media: [] },`, a
