...
| P165 | Not a Trust leaderboard | C | No ranking or comparison surface exists; `artifacts/api-server/src/services/passport/PassportProjectionService.ts:230#"Not a Trust leaderboard"` records the constraint, and the numeric score is self-only. |
