...
| Of those, applied to **portava-ci** | **5** | 2710 `20260908142429`, 2711 `20260908142652`, 2700 `20260908145925`, 2740 `20260908150439`, 2730 `20260908151001` — CI is not production and this row exists so the two are never read as one |
