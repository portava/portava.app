...
| GET | `/api/me/saved-messages` | `artifacts/api-server/src/routes/messaging.ts:2787` |
...
| PATCH | `/api/threads/:threadId/messages/:messageId` | `artifacts/api-server/src/routes/messaging.ts:2443` |
