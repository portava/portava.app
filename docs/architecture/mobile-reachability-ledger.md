...
| GET | `/api/compass/debug/recommendations` | `artifacts/api-server/src/routes/compass.ts:4038` |
...
| GET | `/api/compass/me/context` | `artifacts/api-server/src/routes/compass.ts:340` |
| GET | `/api/compass/me/on-this-day` | `artifacts/api-server/src/routes/compass.ts:2621` |
| GET | `/api/compass/me/passport/remembers` | `artifacts/api-server/src/routes/compass.ts:2420` |
| POST | `/api/compass/me/passport/remembers/correct` | `artifacts/api-server/src/routes/compass.ts:2532` |
| POST | `/api/compass/me/passport/remembers/forget` | `artifacts/api-server/src/routes/compass.ts:2473` |
| GET | `/api/compass/me/recaps` | `artifacts/api-server/src/routes/compass.ts:2594` |
| GET | `/api/compass/people/:userId/passport` | `artifacts/api-server/src/routes/compass.ts:4300` |
| GET | `/api/compass/preload-manifest` | `artifacts/api-server/src/routes/compass.ts:789` |
| POST | `/api/compass/report` | `artifacts/api-server/src/routes/compass.ts:3134` |
