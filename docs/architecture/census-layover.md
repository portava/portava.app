...
`head_commit` IS re-declared, at the commit that carries the five files above.
**This is a re-declaration with three rows re-derived, not a re-measurement**:
§1's reading rule applies unchanged to the other 293.
