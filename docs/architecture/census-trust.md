...
3. **§14.6, TRV2-08** — *"`getRestrictionState` still has exactly **five** non-Trust callers"*.
   ...
   `services/passport/PassportProjectionService.ts:2049#getRestrictionState(sc, userId),`, `lib/calls/callGatewayAdapter.ts:265`,
