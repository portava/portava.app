...
`routes/discoverySearch.ts:2578#buildConsumerProjection(sc,`, `routes/compass.ts:4539#buildConsumerProjection(sc,`, `routes/telegraph.ts:370#buildConsumerProjection(sc,`,
