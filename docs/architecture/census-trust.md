...
`routes/discoverySearch.ts:2634#buildConsumerProjection(sc,`, `routes/compass.ts:4572#buildConsumerProjection(sc,`, `routes/telegraph.ts:386#buildConsumerProjection(sc,`,
