...
`routes/discoverySearch.ts:2688#buildConsumerProjection(sc,`, `routes/compass.ts:4572#buildConsumerProjection(sc,`, `routes/telegraph.ts:386#buildConsumerProjection(sc,`,
