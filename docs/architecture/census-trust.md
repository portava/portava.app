...
- The route is `artifacts/api-server/src/routes/trust-admin.ts:391#router.post(` — behind
  `requireAdmin`, mounted at `artifacts/api-server/src/routes/index.ts:225#trustAdminRouter`,
