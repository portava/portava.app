...
`routes/discoverySearch.ts:3094#buildConsumerProjection(sc,`, `routes/compass.ts:4581#buildConsumerProjection(sc,`, `routes/telegraph.ts:386#buildConsumerProjection(sc,`,
