...
| --- | --- | --- |
| G204 | **C** (set at §9.3) | The table still printed BUILT-BUT-WRONG. The move holds: the local prefix tier is at `travel-buddy-standalone/src/platform/input-assistance/hooks/useInputAssistance.ts:191#localTier`, consulted before the network answers. |
