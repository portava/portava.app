...
`SmartInput.tsx:443#input_opened`, `useInputAssistance.ts:288#suggestion_request_started`
...
## §31 — The offline substrate: the gate G340 built now opens onto something
...
### 31.2 What a local row is not allowed to be
