...
| G220 | lines 1797-1830 | `routes/discoverySearch.ts:2231#dispatchSearch` + `:2057-2094#"travelers":` | the `searchCities` profile select |
| G277 | lines 1664-1685 | `routes/discoverySearch.ts:2109#searchCountries` + `:1932-1933#home_country")` | a `catch { return []; }` |
| G278 | line 1818 | `routes/discoverySearch.ts:2275#searchPlaces` | `let skipped = 0;` |
...
| G283 | lines 1802 and 488 | `routes/discoverySearch.ts:2257#searchTravelers` + `:587#buddy_verified_at` | a `.limit(...)`; a cache JSDoc |
