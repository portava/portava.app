...
37 of 588 migration files reference at least one messaging table.
...
- `src/migrations/2992_layover_decision_record_and_operational_tables.sql`
- `src/migrations/2993_highlight_command_boundary.sql`
