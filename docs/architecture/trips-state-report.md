...
The 90.2 % is a **document measuring itself**. `check:census-integrity` states
...
**Trips: 90.2 % constructed, 52.5 % correct, of 451 requirements — on the branch.**
