...
| --- | --- | --- |
| BUILT (446 / 451) | the census rows' citations, held by `check:doc-citations`; the guards `check:census-integrity` / `-freshness` / `-scope-coverage` | — |
...
**Trips: 98.9 % constructed, 70.1 % correct, of 451 requirements — on the branch.**
