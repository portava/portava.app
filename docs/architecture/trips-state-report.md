...
| --- | --- | --- |
| BUILT (434 / 451) | the census rows' citations, held by `check:doc-citations`; the guards `check:census-integrity` / `-freshness` / `-scope-coverage` | — |
...
**Trips: 96.2 % constructed, 69.4 % correct, of 451 requirements — on the branch.**
