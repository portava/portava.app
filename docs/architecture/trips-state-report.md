...
| --- | --- | --- |
| BUILT (447 / 451) | the census rows' citations, held by `check:doc-citations`; the guards `check:census-integrity` / `-freshness` / `-scope-coverage` | — |
...
**Trips: 99.1 % constructed, 70.1 % correct, of 451 requirements — on the branch.**
