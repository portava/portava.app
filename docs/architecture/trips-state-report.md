...
The 92.9 % is a **document measuring itself**. `check:census-integrity` states
...
**Trips: 92.9 % constructed, 55.7 % correct, of 451 requirements — on the branch.**
