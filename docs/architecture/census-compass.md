...
The ten unreadable rows carry C 4 · W 5 · N 1 between them, so the tool's numbers and this
section's differ by exactly that and by nothing else. Both readings reconcile, before and after the
builds §13.7 records:

| | this document | the tool reads | difference |
|---|---|---|---|
| §13, as measured at `b7f137a4d` | 126 · C 90 · W 31 · N 5 | 116 · C 86 · W 26 · N 4 | the ten rows |
| §13.7, after the three builds | 126 · C 93 · W 28 · N 5 | 116 · C 89 · W 23 · N 4 | the ten rows |

The tool prints the difference itself, as *"10 counted where this tool cannot read"*. **Nothing is
hidden in the gap**, and it is printed on every run rather than asserted here.
