...
- **The client.** `travel-buddy-standalone/src/features/telegraph/` is the
  ...
  `travel-buddy-standalone/app/messages/[id].tsx:2046#SharedContextRail` (direct
...
| T131 | N | **C** | **Rail behaviour: user scrolls down → rail collapses, messages get priority** — `shouldCollapseOnScroll` (`travel-buddy-standalone/src/features/telegraph/sharedContext/railBehavior.ts:29#shouldCollapseOnScroll`) is driven by the conversation's own scroll handler (`travel-buddy-standalone/app/messages/[id].tsx:2071#setRailCollapsed`) and collapses the rail to one line (`railBehavior.component.test.ts:66`, `SharedContextRail.component.test.tsx:148`). |
...
- **The client half, including the cards that were already wrong.**
  ...
  (`travel-buddy-standalone/app/messages/[id].tsx:833#PortavaObjectMessage`,
...
- **The client.** `TypedMessageRenderer`
  ...
  `travel-buddy-standalone/app/messages/[id].tsx:820#rendersTypedKind`. The
  content drawer replaces the dead code at
  `travel-buddy-standalone/app/messages/[id].tsx:1915#telegraph-open-content-drawer`
  ...
  (`travel-buddy-standalone/app/messages/[id].tsx:2296#setShowPlusMenu`).
...
- **The client panel** is §2.2's "OPTIONAL COORDINATION PANEL", between the
  rail and the stream
  (`travel-buddy-standalone/app/messages/[id].tsx:2051#CoordinationPanel`,
