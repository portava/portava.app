...
| VF-4c | `verification_revoked` clears `profiles.verification_level` | TV-4c `C` | SATISFIED | `routes/admin.ts:1646#verification_level: "none",`; pinned by `adminUnverifyRevokesIdLevel.test.ts` (5/5). |
