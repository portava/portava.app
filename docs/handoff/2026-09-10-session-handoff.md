...
| trips | 451 | 88 → **313** (§40–§62, branch) | 162 → **122** | 200 → **15** | 1 | 0 | 19.5 % → **69.4 %** | 55.4 % → **96.5 %** |
...
after census-trips §40.1–§62 on `claude/sweet-fermat-fmx7up` (not merged) it is
**313 C / 122 W / 15 N / 1 X — 96.5 % constructed, 69.4 % correct**, every moved row
