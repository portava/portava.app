...
| trips | 451 | 88 → **297** (§40–§54, branch) | 162 → **129** | 200 → **24** | 1 | 0 | 19.5 % → **65.9 %** | 55.4 % → **94.5 %** |
...
after census-trips §40.1–§54 on `claude/sweet-fermat-fmx7up` (not merged) it is
**297 C / 129 W / 24 N / 1 X — 94.5 % constructed, 65.9 % correct**, every moved row
