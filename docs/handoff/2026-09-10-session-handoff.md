...
| trips | 451 | 88 → **268** (§40–§47, branch) | 162 → **153** | 200 → **29** | 1 | 0 | 19.5 % → **59.4 %** | 55.4 % → **93.3 %** |
...
after census-trips §40.1–§47 on `claude/sweet-fermat-fmx7up` (not merged) it is
**268 C / 153 W / 29 N / 1 X — 93.3 % constructed, 59.4 % correct**, every moved row
