...
| trips | 451 | 88 → **264** (§40–§46, branch) | 162 → **155** | 200 → **31** | 1 | 0 | 19.5 % → **58.5 %** | 55.4 % → **92.9 %** |
...
after census-trips §40.1–§46 on `claude/sweet-fermat-fmx7up` (not merged) it is
**264 C / 155 W / 31 N / 1 X — 92.9 % constructed, 58.5 % correct**, every moved row
