...
| trips | 451 | 88 → **311** (§40–§59, branch) | 162 → **121** | 200 → **18** | 1 | 0 | 19.5 % → **69.0 %** | 55.4 % → **95.8 %** |
...
after census-trips §40.1–§59 on `claude/sweet-fermat-fmx7up` (not merged) it is
**311 C / 121 W / 18 N / 1 X — 95.8 % constructed, 69.0 % correct**, every moved row
