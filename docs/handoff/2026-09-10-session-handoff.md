...
| trips | 451 | 88 → **170** (§40–§42, branch) | 162 → **176** | 200 → **104** | 1 | 0 | 19.5 % → **37.7 %** | 55.4 % → **76.7 %** |
...
after census-trips §40.1–§42 on `claude/sweet-fermat-fmx7up` (not merged) it is
**170 C / 176 W / 104 N / 1 X — 76.7 % constructed, 37.7 % correct**, every moved row
