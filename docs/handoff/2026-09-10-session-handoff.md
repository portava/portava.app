...
| trips | 451 | 88 → **201** (§40–§43, branch) | 162 → **174** | 200 → **75** | 1 | 0 | 19.5 % → **44.6 %** | 55.4 % → **83.1 %** |
...
after census-trips §40.1–§43 on `claude/sweet-fermat-fmx7up` (not merged) it is
**201 C / 174 W / 75 N / 1 X — 83.1 % constructed, 44.6 % correct**, every moved row
