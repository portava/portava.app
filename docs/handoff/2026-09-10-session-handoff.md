...
| trips | 451 | 88 → **275** (§40–§49, branch) | 162 → **151** | 200 → **24** | 1 | 0 | 19.5 % → **61.0 %** | 55.4 % → **94.5 %** |
...
after census-trips §40.1–§49 on `claude/sweet-fermat-fmx7up` (not merged) it is
**275 C / 151 W / 24 N / 1 X — 94.5 % constructed, 61.0 % correct**, every moved row
