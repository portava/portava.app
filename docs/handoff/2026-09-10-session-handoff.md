...
| trips | 451 | 88 → **290** (§40–§53, branch) | 162 → **136** | 200 → **24** | 1 | 0 | 19.5 % → **64.3 %** | 55.4 % → **94.5 %** |
...
after census-trips §40.1–§53 on `claude/sweet-fermat-fmx7up` (not merged) it is
**290 C / 136 W / 24 N / 1 X — 94.5 % constructed, 64.3 % correct**, every moved row
