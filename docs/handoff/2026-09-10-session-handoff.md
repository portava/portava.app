...
| trips | 451 | 88 → **316** (§40–§63, branch) | 162 → **130** | 200 → **4** | 1 | 0 | 19.5 % → **70.1 %** | 55.4 % → **98.9 %** |
...
after census-trips §40.1–§63 on `claude/sweet-fermat-fmx7up` (not merged) it is
**316 C / 130 W / 4 N / 1 X — 98.9 % constructed, 70.1 % correct**, every moved row
