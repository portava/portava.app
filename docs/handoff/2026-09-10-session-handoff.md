...
| trips | 451 | 88 → **308** (§40–§57, branch) | 162 → **118** | 200 → **24** | 1 | 0 | 19.5 % → **68.3 %** | 55.4 % → **94.5 %** |
...
after census-trips §40.1–§57 on `claude/sweet-fermat-fmx7up` (not merged) it is
**308 C / 118 W / 24 N / 1 X — 94.5 % constructed, 68.3 % correct**, every moved row
