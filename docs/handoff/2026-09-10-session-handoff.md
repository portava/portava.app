...
| trips | 451 | 88 → **299** (§40–§55, branch) | 162 → **127** | 200 → **24** | 1 | 0 | 19.5 % → **66.3 %** | 55.4 % → **94.5 %** |
...
after census-trips §40.1–§55 on `claude/sweet-fermat-fmx7up` (not merged) it is
**299 C / 127 W / 24 N / 1 X — 94.5 % constructed, 66.3 % correct**, every moved row
