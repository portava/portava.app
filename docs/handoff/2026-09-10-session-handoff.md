...
| trips | 451 | 88 → **286** (§40–§52, branch) | 162 → **140** | 200 → **24** | 1 | 0 | 19.5 % → **63.4 %** | 55.4 % → **94.5 %** |
...
after census-trips §40.1–§52 on `claude/sweet-fermat-fmx7up` (not merged) it is
**286 C / 140 W / 24 N / 1 X — 94.5 % constructed, 63.4 % correct**, every moved row
