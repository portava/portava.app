...
| trips | 451 | 88 → **311** (§40–§58, branch) | 162 → **116** | 200 → **23** | 1 | 0 | 19.5 % → **69.0 %** | 55.4 % → **94.7 %** |
...
after census-trips §40.1–§58 on `claude/sweet-fermat-fmx7up` (not merged) it is
**311 C / 116 W / 23 N / 1 X — 94.7 % constructed, 69.0 % correct**, every moved row
