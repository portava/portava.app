...
| trips | 451 | 88 → **271** (§40–§48, branch) | 162 → **155** | 200 → **24** | 1 | 0 | 19.5 % → **60.1 %** | 55.4 % → **94.5 %** |
...
after census-trips §40.1–§48 on `claude/sweet-fermat-fmx7up` (not merged) it is
**271 C / 155 W / 24 N / 1 X — 94.5 % constructed, 60.1 % correct**, every moved row
