...
- [Mock data fixture isolation](fixture-isolation.md) — src/data/ files are thin re-exports from src/__fixtures__/; still imported in live screens as fallbacks; see QA report for screens still using fixture data
