...
function SessionProvider(_a) {
    ...
    return (<SessionContext.Provider value={{ userId: userId, isAuthed: Boolean(userId), loading: loading, configured: supabase_1.isSupabaseConfigured, signOut: signOut }}>
      {children}
    </SessionContext.Provider>);
}
function useSession() {
    var _this = this;
    var ctx = (0, react_1.useContext)(SessionContext);
    if (!ctx) {
        return { userId: null, isAuthed: false, loading: false, configured: supabase_1.isSupabaseConfigured, signOut: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/];
            }); }); } };
    }
    return ctx;
