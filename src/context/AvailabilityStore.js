...
function AvailabilityProvider(_a) {
    ...
    var _c = (0, react_1.useState)((_b = events_1.mockAvailability) !== null && _b !== void 0 ? _b : EMPTY), availability = _c[0], setAvailability = _c[1];
    ...
    var value = (0, react_1.useMemo)(function () { return ({ availability: availability, toggleBlock: toggleBlock, applyWeekly: applyWeekly, clearWeekly: clearWeekly, setOpenToMeet: setOpenToMeet, addTripWindow: addTripWindow, removeTripWindow: removeTripWindow, save: save }); }, [availability, toggleBlock, applyWeekly, clearWeekly, setOpenToMeet, addTripWindow, removeTripWindow, save]);
