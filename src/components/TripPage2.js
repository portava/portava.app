...
function TripPlans(_a) {
    ...
    return (<react_native_1.View>
      ...
      {visible.length === 0 ? (<primitives_1.TravelEmptyState title="No trip plans yet" sub="Add one from Pulse or create your own." action="Browse Pulse" onAction={function () { return expo_router_1.router.push('/(tabs)/'); }}/>) : (<react_native_1.View style={p.list}>
...
function TripCircle(_a) {
    var cityCount = _a.cityCount, inCity = _a.inCity, suggested = _a.suggested;
    return (<react_native_1.View>
      ...
      <react_native_1.View style={c.card}>
        ...
        <react_native_1.View style={c.avatars}>
          {inCity.map(function (u) { return (<react_native_1.Pressable key={u.id} onPress={function () { return expo_router_1.router.push("/profile/".concat(u.handle)); }} style={c.avatarWrap}>
              <react_native_1.Image source={{ uri: u.avatarUrl }} style={c.avatar}/>
    ...
    return (<react_native_1.View>
      ...
      <react_native_1.View style={sf.card}>
        ...
        <react_native_1.View style={sf.btns}>
          <react_native_1.Pressable style={sf.btn} onPress={function () { return expo_router_1.router.push('/settings'); }}><react_native_1.Text style={sf.btnText}>Start Safe Return</react_native_1.Text></react_native_1.Pressable>
          <react_native_1.Pressable style={sf.btn} onPress={function () { return expo_router_1.router.push('/settings'); }}><react_native_1.Text style={sf.btnText}>Emergency Contacts</react_native_1.Text></react_native_1.Pressable>
        </react_native_1.View>
