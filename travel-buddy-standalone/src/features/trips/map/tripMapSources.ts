...
import type { CrewMemberCard, CrewStatusLabel } from '../crew/tripCrewLocation.ts';
import { presenceFreshnessState, presenceIsCurrent, presenceLine } from '../crew/presence.ts';
