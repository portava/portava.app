...
import { serviceFailure, thrownFailure } from '../../../services/serviceFailure.ts';
...
export interface CrewMemberCard {
   ...
   * judged LIVE / RECENT on its own clock (api-server domain/trips/services/tripCrewLocation.ts).
