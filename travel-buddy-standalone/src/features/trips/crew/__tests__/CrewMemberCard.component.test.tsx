...
import type { CrewMemberCard as Card } from '../tripCrewLocation.ts';
...
jest.mock('../../../../components/interaction/UserIdentityLink.tsx', () => {
...
jest.mock('../../../../components/interaction/UserOverflowMenu.tsx', () => ({ UserOverflowMenu: () => null }));
