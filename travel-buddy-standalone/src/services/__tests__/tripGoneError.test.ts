...
describe('mapAcceptResultToAction — gone path transitions screen state (not Alert)', () => {
  it('returns { kind: "set_gone" } for { error: "gone" } with no reason', () => {
