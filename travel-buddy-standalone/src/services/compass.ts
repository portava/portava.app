...
/** For tests only — override AsyncStorage. Pass null to simulate no storage. Pass undefined to clear. */
export function _setStorageForTest(s: AsyncStorageStub | null | undefined): void {
  _testStorage = s;
}
