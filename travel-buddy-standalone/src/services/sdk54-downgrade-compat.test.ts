...
describe('SDK 54 downgrade — package version pins', () => {
  // In the standalone tree src/services/ is 2 levels below the standalone root
  // and 3 levels below the workspace root, so artifacts/travel-buddy is
  // ../../../artifacts/travel-buddy from here.
  ...
  it('versions are in sync between artifacts/travel-buddy and travel-buddy-standalone', () => {
    // This tree's own package.json is 2 levels up from src/services.
...
describe('SDK 54 downgrade — peer dep sync between artifacts/travel-buddy and travel-buddy-standalone', () => {
  // artifacts/travel-buddy/package.json is 3 levels up from src/services in the standalone tree.
  ...
  // travel-buddy-standalone/package.json is 2 levels up from src/services in the standalone tree.
...
describe('Lockfile-resolved transitive peer dep versions — @babel/core, @expo/config-plugins, expo-modules-core, and metro bundler family', () => {
  // travel-buddy-standalone/pnpm-lock.yaml is 2 levels up from src/services/ in the standalone tree.
