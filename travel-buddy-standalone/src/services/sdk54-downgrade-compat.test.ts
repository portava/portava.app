...
describe('SDK 54 downgrade — package version pins', () => {
  // This file lives in the standalone tree, so ../../package.json (2 levels
  // up from src/services) is travel-buddy-standalone/package.json — the
  // standalone copy whose pins are asserted below.
