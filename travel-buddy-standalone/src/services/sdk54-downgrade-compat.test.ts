...
describe('SDK 54 downgrade — peer dep sync between artifacts/travel-buddy and travel-buddy-standalone', () => {
  // artifacts/travel-buddy/package.json is 3 levels up from src/services/ in travel-buddy-standalone.
  ...
  // travel-buddy-standalone/package.json is 2 levels up from src/services/ (this file's own root).
...
describe('Lockfile-resolved transitive peer dep versions — @babel/core, @expo/config-plugins, expo-modules-core, and metro bundler family', () => {
  // travel-buddy-standalone/pnpm-lock.yaml is 2 levels up from src/services/ (this file's own root).
