...
const s = StyleSheet.create({
  ...
  icon: { width: icon.s22, height: icon.s22, borderRadius: icon.s22 / 2, backgroundColor: '#FFF0EE', alignItems: 'center', justifyContent: 'center' },
  ...
  sendBtn: { width: avatar.s34, height: avatar.s34, borderRadius: avatar.s34 / 2, backgroundColor: color.signal, alignItems: 'center', justifyContent: 'center' },
