...
const tl = StyleSheet.create({
  ...
  dot: { width: dot.lg, height: dot.lg, borderRadius: dot.lg / 2, backgroundColor: color.signal, marginTop: 4 },
...
const cr = StyleSheet.create({
  ...
  avatarWrap: {},
  onlineDot: { position: 'absolute', right: 0, bottom: 0, width: dot.xl, height: dot.xl, borderRadius: dot.xl / 2, backgroundColor: color.success, borderWidth: 2, borderColor: color.paperRaised },
