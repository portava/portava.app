...
const s = StyleSheet.create({
  ...
  checkbox:         { width: icon.s22, height: icon.s22, borderRadius: icon.s22 / 2, borderWidth: 1.5, borderColor: color.haze, alignItems: 'center', justifyContent: 'center', backgroundColor: color.paper },
  checkboxActive:   { backgroundColor: color.signal, borderColor: color.signal },
  checkboxLocked:   { width: icon.s22, height: icon.s22, borderRadius: icon.s22 / 2, borderWidth: 1.5, borderColor: color.signal, alignItems: 'center', justifyContent: 'center', backgroundColor: color.paperRaised },
