...
const s = StyleSheet.create({
  ...
  approveBtn: { width: avatar.s36, height: avatar.s36, borderRadius: avatar.s36 / 2, backgroundColor: '#DCFCE7', alignItems: 'center', justifyContent: 'center' },
  denyBtn:    { width: avatar.s36, height: avatar.s36, borderRadius: avatar.s36 / 2, backgroundColor: '#FEE2E2', alignItems: 'center', justifyContent: 'center' },
  ...
  iconBtn:    { width: avatar.s32, height: avatar.s32, borderRadius: avatar.s32 / 2, backgroundColor: color.haze, alignItems: 'center', justifyContent: 'center' },
