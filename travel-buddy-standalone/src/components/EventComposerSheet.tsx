...
const s = StyleSheet.create({
  ...
  stepDot:    { width: dot.xs, height: dot.xs, borderRadius: dot.xs / 2, backgroundColor: color.haze },
  ...
  visDot:     { width: dot.md, height: dot.md, borderRadius: dot.md / 2, backgroundColor: color.signal },
