...
const s = StyleSheet.create({
  ...
  optionIcon: { width: avatar.s36, height: avatar.s36, borderRadius: avatar.s36 / 2, backgroundColor: '#F0F4FF', alignItems: 'center', justifyContent: 'center' },
  optionText: { flex: 1 },
  ...
  memberAvatar: { width: avatar.s36, height: avatar.s36, borderRadius: avatar.s36 / 2, backgroundColor: color.deep, alignItems: 'center', justifyContent: 'center' },
