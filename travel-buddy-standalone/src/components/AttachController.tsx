...
const s = StyleSheet.create({
  ...
  rowIcon: { width: avatar.s34, height: avatar.s34, borderRadius: avatar.s34 / 2, backgroundColor: '#E2EDF0', alignItems: 'center', justifyContent: 'center' },
  ...
  createIcon: { width: avatar.s34, height: avatar.s34, borderRadius: avatar.s34 / 2, backgroundColor: color.signal, alignItems: 'center', justifyContent: 'center' },
