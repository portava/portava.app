...
const betaStyles = StyleSheet.create({
  ...
  statusDot: { width: dot.md, height: dot.md, borderRadius: dot.md / 2 },
...
const auditStyles = StyleSheet.create({
  ...
  actionDot: { width: dot.md, height: dot.md, borderRadius: dot.md / 2, backgroundColor: color.signal, marginTop: 4 },
