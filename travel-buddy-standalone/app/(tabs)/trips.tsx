...
const styles = StyleSheet.create({
  ...
  inviterAvatar: { width: icon.s20, height: icon.s20, borderRadius: icon.s20 / 2 },
  inviterAvatarPlaceholder: { width: icon.s20, height: icon.s20, borderRadius: icon.s20 / 2, backgroundColor: color.haze, alignItems: 'center', justifyContent: 'center' },
