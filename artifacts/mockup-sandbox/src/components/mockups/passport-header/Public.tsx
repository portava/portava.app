...
function StatTicket({ value, label, icon, accent }: { value: string; label: string; icon: React.ReactNode; accent: string }) {
  return (
        ...
        <div className="card-body">
          <div className="left-col">
            ...
            <div className="avatar-area">
              ...
              {/* No camera button on public view */}
            </div>
          ...
          <div className="right-col">
            ...
            {/* Public actions: Follow + Telegraph */}
            <div className="owner-actions" style={{ marginTop: 6 }}>
              <button className="follow-pill">
                <UserPlus size={13} color="#fff" strokeWidth={2} />
                <span>Follow</span>
              </button>
              <button className="action-card action-saved" style={{ flexDirection: 'row', gap: 5, padding: '8px 12px' }}>
                <Send size={14} color={INK} strokeWidth={1.8} />
