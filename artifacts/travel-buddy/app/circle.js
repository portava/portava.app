...
function Circle() {
    ...
    return (<react_native_1.View style={{ flex: 1, backgroundColor: tokens_1.color.paper }}>
      ...
      {tab === 'circle' && following.length > 0 && (<react_native_1.View style={styles.safeReturnHint}>
          <lucide_react_native_1.Shield size={13} color={tokens_1.color.deep}/>
          <react_native_1.Text style={styles.safeReturnHintText}>
            People you follow can be added as{' '}
            <react_native_1.Text style={styles.safeReturnHintBold}>Trusted Contacts</react_native_1.Text>
...
var styles = react_native_1.StyleSheet.create({
    ...
    safeReturnHint: {
        flexDirection: 'row', alignItems: 'flex-start', gap: tokens_1.space.sm,
        marginHorizontal: tokens_1.space.lg, marginTop: tokens_1.space.sm, marginBottom: 0,
        backgroundColor: tokens_1.color.paperRaised, borderRadius: tokens_1.radius.md,
        borderWidth: 1, borderColor: tokens_1.color.haze,
        paddingHorizontal: tokens_1.space.md, paddingVertical: tokens_1.space.sm + 2,
    },
    safeReturnHintText: __assign(__assign({}, tokens_1.type.small), { color: tokens_1.color.mute, fontSize: 12, lineHeight: 18, flex: 1 }),
    safeReturnHintBold: { fontWeight: '700', color: tokens_1.color.ink },
