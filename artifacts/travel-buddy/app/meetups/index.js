    ...
    return (<react_native_1.Pressable style={styles.row} onPress={function () { return expo_router_1.router.push("/meetup/".concat(meetup.id)); }}>
      ...
      <react_native_1.View style={styles.rowBody}>
        ...
        <react_native_1.View style={styles.footRow}>
          <react_native_1.View style={styles.metaRow}>
            <lucide_react_native_1.Users size={13} color={tokens_1.color.faint}/>
            <react_native_1.Text style={styles.metaFaint}>
              {meetup.counts.going} going · {meetup.counts.maybe} maybe
              {totalAttendees > 0 ? " \u00B7 ".concat(totalAttendees, " invited") : ''}
            </react_native_1.Text>
          </react_native_1.View>
...
var styles = react_native_1.StyleSheet.create({
    ...
    metaFaint: __assign(__assign({}, tokens_1.type.small), { color: tokens_1.color.faint, flex: 1 }),
    footRow: {
        flexDirection: 'row',
        alignItems: 'center',
