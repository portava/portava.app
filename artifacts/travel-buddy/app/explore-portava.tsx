...
const SECTIONS: DirectorySection[] = [
  {
    ...
    data: [
      ...
      { key: 'following',  label: 'Following',   Icon: UserPlus,      iconColor: '#D97706', disabled: true },
      { key: 'followers',  label: 'Followers',   Icon: Users,         iconColor: '#4F46E5', disabled: true },
  ...
  },
  {
    ...
    data: [
      ...
      { key: 'pp-followers',   label: 'Followers',         Icon: Users,        iconColor: '#DB2777', disabled: true },
      { key: 'pp-following',   label: 'Following',         Icon: UserPlus,     iconColor: '#059669', disabled: true },
