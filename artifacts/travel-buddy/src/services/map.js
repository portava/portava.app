...
exports.listNearbyUsers = listNearbyUsers;
 ...
 */
function listNearbyUsers(city, excludeUserId) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, data, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!supabase_1.isSupabaseConfigured || !city.trim())
                        return [2 /*return*/, []];
                ...
                case 1:
                    ...
                    return [2 /*return*/, data.map(function (r) {
                            ...
                            return ({
                                id: r.id,
                                name: (_a = r.name) !== null && _a !== void 0 ? _a : 'Traveler',
                                avatarUrl: (_b = r.avatar_url) !== null && _b !== void 0 ? _b : null,
                            });
                        })];
            }
        });
