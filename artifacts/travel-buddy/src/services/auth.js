...
function lookupUsernameByEmail(email) {
    return __awaiter(this, void 0, void 0, function () {
        var apiBase, res, data, _a;
        var _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    apiBase = (_b = process.env.EXPO_PUBLIC_API_BASE_URL) !== null && _b !== void 0 ? _b : '';
                    if (!apiBase)
                        return [2 /*return*/, { error: 'Backend not configured.' }];
                    _d.label = 1;
                case 1:
                ...
                case 3:
                    data = _d.sent();
                    if (!res.ok)
                        return [2 /*return*/, { error: (_c = data === null || data === void 0 ? void 0 : data.error) !== null && _c !== void 0 ? _c : 'Could not find an account with that email.' }];
