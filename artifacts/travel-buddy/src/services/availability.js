...
exports.patchMyAvailability = patchMyAvailability;
exports.getMyQuickStatus = getMyQuickStatus;
exports.patchMyQuickStatus = patchMyQuickStatus;
exports.getTripAvailability = getTripAvailability;
exports.patchTripAvailability = patchTripAvailability;
exports.patchTripOpenDays = patchTripOpenDays;
exports.getCircleAvailability = getCircleAvailability;
exports.getAvailabilityNudges = getAvailabilityNudges;
/**
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    body = _c.sent();
                    return [2 /*return*/, { ok: false, data: null, message: (_b = body === null || body === void 0 ? void 0 : body.message) !== null && _b !== void 0 ? _b : "API ".concat(res.status) }];
                case 5:
                    _a = { ok: true };
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 7:
                    e_2 = _c.sent();
                    return [2 /*return*/, { ok: false, data: null, message: e_2 instanceof Error ? e_2.message : 'Network error' }];
                case 8: return [2 /*return*/];
            }
        });
    });
...
function getMyAvailability() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, apiGet('/api/me/availability')];
        });
    });
}
function patchMyAvailability(patch) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, apiPatch('/api/me/availability', patch)];
        });
    });
}
function getMyQuickStatus() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, apiGet('/api/me/quick-availability')];
        });
    });
}
function patchMyQuickStatus(status, expiresAt) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, apiPatch('/api/me/quick-availability', __assign({ status: status }, (expiresAt ? { expiresAt: expiresAt } : {})))];
        });
    });
}
function getTripAvailability(tripId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, apiGet("/api/trips/".concat(tripId, "/availability"))];
        });
    });
}
function patchTripAvailability(tripId, patch) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, apiPatch("/api/trips/".concat(tripId, "/availability"), patch)];
        });
    });
}
function patchTripOpenDays(tripId, openDays) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, apiPatch("/api/trips/".concat(tripId, "/availability"), { openDays: openDays })];
        });
    });
}
// ── Circle availability ───────────────────────────────────────────────────────
function getCircleAvailability(circleId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, apiGet("/api/circles/".concat(circleId, "/availability"))];
        });
    });
}
function getAvailabilityNudges() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, apiGet('/api/me/availability-nudges')];
        });
    });
}
