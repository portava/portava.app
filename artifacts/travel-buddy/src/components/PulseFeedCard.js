...
var PostEngagementBar_1 = require("./PostEngagementBar");
 ...
 */
function resolveLocationChipVariant(visibility, neighborhood) {
    switch (visibility) {
...
function AuthorRow(_a) {
    ...
    var ringState = (0, useHighlightRingState_1.useHighlightRingState)((_c = (_b = item.author) === null || _b === void 0 ? void 0 : _b.id) !== null && _c !== void 0 ? _c : null);
    var _f = (0, react_1.useState)(false), viewerOpen = _f[0], setViewerOpen = _f[1];
    return (<react_native_1.View style={s.authorRow}>
      {item.author ? (<HighlightRing_1.HighlightRing hasActive={(_d = ringState === null || ringState === void 0 ? void 0 : ringState.hasActive) !== null && _d !== void 0 ? _d : false} allViewed={(_e = ringState === null || ringState === void 0 ? void 0 : ringState.allViewed) !== null && _e !== void 0 ? _e : false} size={36} ringWidth={2} gap={2} onPress={(ringState === null || ringState === void 0 ? void 0 : ringState.hasActive) ? function () { return setViewerOpen(true); } : undefined}>
          <react_native_1.Image source={{ uri: item.author.avatarUrl }} style={s.avatar}/>
        </HighlightRing_1.HighlightRing>) : null}
      ...
      <react_native_1.Pressable hitSlop={tokens_1.layout.hitSlop} onPress={function () {
            return react_native_1.Alert.alert('Post Options', undefined, [
                { text: 'Report', onPress: function () { return react_native_1.Alert.alert('Coming Soon', 'Post reporting is coming in a future update.'); } },
                { text: 'Hide', onPress: function () { return react_native_1.Alert.alert('Coming Soon', 'Post hiding is coming in a future update.'); } },
                { text: 'Cancel', style: 'cancel' },
            ]);
        }}>
        <lucide_react_native_1.MoreHorizontal size={18} color={tokens_1.color.faint}/>
      </react_native_1.Pressable>

      {(ringState === null || ringState === void 0 ? void 0 : ringState.highlights) && (<HighlightViewer_1.HighlightViewer visible={viewerOpen} highlights={ringState.highlights} currentUserId={currentUserId !== null && currentUserId !== void 0 ? currentUserId : undefined} onClose={function () { return setViewerOpen(false); }}/>)}
    </react_native_1.View>);
}
function TagRow(_a) {
    var tags = _a.tags;
...
function PostCard(_a) {
    ...
    var item = _a.item;
    var chipVariant = resolveLocationChipVariant(item.locationVisibility, item.neighborhood);
    var chipLabel = (_c = (_b = item.venueName) !== null && _b !== void 0 ? _b : item.neighborhood) !== null && _c !== void 0 ? _c : item.city;
    var chipSublabel = (_d = item.locationDistrict) !== null && _d !== void 0 ? _d : (item.neighborhood ? item.city : undefined);
    return (<react_native_1.View style={s.card}>
      ...
      {chipVariant !== 'no_location' && (<react_native_1.View style={s.locationRow}>
          <LocationChip_1.LocationChip variant={chipVariant} label={chipLabel} sublabel={chipSublabel} size="sm" muted/>
        </react_native_1.View>)}
      <PostEngagementBar_1.PostEngagementBar postId={item.id} likeCount={(_e = item.likeCount) !== null && _e !== void 0 ? _e : 0} commentCount={(_f = item.commentCount) !== null && _f !== void 0 ? _f : 0} likedByMe={(_g = item.likedByMe) !== null && _g !== void 0 ? _g : false} canLike={item.canLike !== false} canComment={item.canComment !== false} canShare={item.canShare !== false}/>
    </react_native_1.View>);
}
/* ── Question ── */
function QuestionCard(_a) {
    ...
    return (<react_native_1.View style={s.card}>
      ...
      {item.source === 'user' && (<PostEngagementBar_1.PostEngagementBar postId={item.id} likeCount={(_c = item.likeCount) !== null && _c !== void 0 ? _c : 0} commentCount={(_d = item.commentCount) !== null && _d !== void 0 ? _d : 0} likedByMe={(_e = item.likedByMe) !== null && _e !== void 0 ? _e : false} canLike={item.canLike !== false} canComment={item.canComment !== false} canShare={item.canShare !== false}/>)}
    </react_native_1.View>);
}
/* ── Open Plan ── */
function PlanCard(_a) {
    var _b, _c;
    var item = _a.item;
    var planPicker = (0, PlanPickerController_1.usePlanPicker)();
    return (<react_native_1.View style={s.card}>
      ...
      <react_native_1.View style={s.actions}>
        ...
        return [s.outlineBtn, pressed && { opacity: 0.7 }];
    }} onPress={function () { var _a; return planPicker.open({ id: item.id, type: 'meetup', title: (_a = item.title) !== null && _a !== void 0 ? _a : 'Meetup', city: item.city }); }}>
          <react_native_1.Text style={s.outlineText}>Add to Plan</react_native_1.Text>
        </react_native_1.Pressable>
        ...
        <TelegraphFeedbackMenu_1.TelegraphFeedbackMenu recommendationId={item.id} category={item.type}/>
      </react_native_1.View>
    </react_native_1.View>);
}
/* ── Hidden Gem Share ── */
function GemCard(_a) {
    ...
    return (<react_native_1.View style={s.card}>
      ...
      <react_native_1.View style={s.actions}>
        <react_native_1.Pressable style={s.outlineBtn} onPress={function () { var _a; return planPicker.open({ id: item.id, type: 'hidden_gem', title: (_a = item.title) !== null && _a !== void 0 ? _a : 'Hidden gem', city: item.city, category: 'Hidden Gem' }); }}><react_native_1.Text style={s.outlineText}>Add to Plan</react_native_1.Text></react_native_1.Pressable>
        <react_native_1.View style={{ flex: 1 }}/>
        <react_native_1.Pressable hitSlop={tokens_1.layout.hitSlop} onPress={function () { return react_native_1.Alert.alert('Coming Soon', 'Saving recommendations is coming in a future update.'); }}><lucide_react_native_1.Bookmark size={17} color={tokens_1.color.mute}/></react_native_1.Pressable>
        <TelegraphFeedbackMenu_1.TelegraphFeedbackMenu recommendationId={item.id} category={item.type}/>
      </react_native_1.View>
    </react_native_1.View>);
}
...
function ItineraryCard(_a) {
    ...
    return (<react_native_1.View style={s.card}>
      ...
      <TagRow tags={item.tags}/>
      <react_native_1.View style={s.actions}>
        <react_native_1.Pressable style={s.outlineBtn} onPress={function () { var _a; return planPicker.open({ id: item.id, type: 'experience', title: (_a = item.title) !== null && _a !== void 0 ? _a : 'Itinerary', city: item.city, category: 'Itinerary' }); }}><react_native_1.Text style={s.outlineText}>Use this plan</react_native_1.Text></react_native_1.Pressable>
        <react_native_1.View style={{ flex: 1 }}/>
        <react_native_1.Pressable hitSlop={tokens_1.layout.hitSlop} onPress={function () { return react_native_1.Alert.alert('Coming Soon', 'Saving itineraries is coming in a future update.'); }}><lucide_react_native_1.Bookmark size={17} color={tokens_1.color.mute}/></react_native_1.Pressable>
      </react_native_1.View>
    </react_native_1.View>);
}
/* ── Circle Activity ── */
...
function CompassCard(_a) {
    ...
    return (<react_native_1.View style={[s.card, s.compassCard]}>
      ...
      <react_native_1.View style={s.actions}>
        ...
        <react_native_1.View style={{ flex: 1 }}/>
        <react_native_1.Pressable style={s.solidBtn} onPress={function () { var _a; return planPicker.open({ id: item.id, type: 'compass_suggestion', title: (_a = item.title) !== null && _a !== void 0 ? _a : 'Compass pick', city: item.city, category: 'Compass' }); }}><lucide_react_native_1.Plus size={14} color={tokens_1.color.onInk}/><react_native_1.Text style={s.solidText}>Add to Plan</react_native_1.Text></react_native_1.Pressable>
      </react_native_1.View>
    </react_native_1.View>);
}
