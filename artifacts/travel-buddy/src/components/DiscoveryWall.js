      ...
      <react_native_1.Pressable style={cp.hero} onPress={function () { return expo_router_1.router.push('/(tabs)/ai'); }}>
        ...
        <react_native_1.View style={cp.heroBody}>
          ...
          <react_native_1.View style={cp.heroBtns}>
            ...
            <react_native_1.Pressable style={cp.addBtn} onPress={function () { return planPicker.open({ id: pick.id, type: 'experience', title: pick.name, city: pick.city, category: 'Compass Pick' }); }}>
              <lucide_react_native_1.Plus size={15} color={tokens_1.color.onInk}/><react_native_1.Text style={cp.addText}>Add to Plan</react_native_1.Text>
            </react_native_1.Pressable>
          </react_native_1.View>
        </react_native_1.View>
      </react_native_1.Pressable>
