...
const READ_ONLY_AUDIT_ENTRY_POINTS = [
  ...
  },
  {
    ...
    reason:
      ...
      'mutate production to test it. It exists because audit:schema checks that each grant a migration CLAIMS ' +
      'is PRESENT, which is not the same as checking the privilege set is EXACTLY what was claimed: it cannot ' +
      'see excess privilege and does not model REVOKE at all. Migration 2092 claimed service_role held INSERT ' +
      'and SELECT "and nothing else"; both were present, five more were too, and every gate went green. That ' +
      'is a question about production specifically, since the append-only guarantee D7=A rests on is a ' +
      'property of the live catalog and of nothing else.',
  },
  {
