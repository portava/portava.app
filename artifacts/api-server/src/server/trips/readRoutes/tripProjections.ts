 ...
 * `trip_operational_projections_enabled` (domain/trips/policies/tripOperationalProjections.ts),
 ...
 * server/trips/readRoutes/tripMapProjection.ts established the order — so it names the state
 ...
 * Appendix B reasons (domain/trips/contracts/tripReasonCodes.ts).
 */
...
import { previewImpact, CHANGE_KINDS, type ProposedChange } from "../../../domain/trips/services/TripImpactPreview.js";
import { simulateChange, type ReplanConstraints } from "../../../domain/trips/services/TripReplan.js";
import { computeReplan, computeMeetingPoint } from "../../../domain/trips/services/TripReplanService.js";
import { planRescue, RESCUE_PROBLEMS, type RescueProblem } from "../../../domain/trips/services/TripRescue.js";
...
import { incrementTripMetric } from "../../../domain/trips/services/tripMetrics.js";
import { randomUUID } from "node:crypto";
import { recordNotificationActed } from "../../../domain/trips/policies/tripPush.js";
...
import { TRIP_PUSH_EVENT_PROFILES } from "../../../domain/trips/policies/TripAttentionPolicy.js";
...
// trip push (`data.type`). The sent side is recorded by domain/trips/policies/tripPush.ts at
...
router.get("/trips/:tripId/safety", asyncHandler(async (req, res) => {
  ...
  // domain/trips/services/TripCrewLocationService.ts) — refused, not emptied.
