 ...
 * for this projection is `GET /trips/:id/map`; server/trips/readRoutes/tripProjections.ts
...
/** The projection, after authentication. Shared with `GET /trips/:tripId/map` (server/trips/readRoutes/tripProjections.ts). */
