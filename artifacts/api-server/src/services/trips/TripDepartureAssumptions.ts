 ...
 */
import { localHour, localDayString, isValidTimezone } from "../airport/AirportTime.js";
import type {
  TravelAssumption,
  TravelMode,
  TravelTimeProvider,
...
const SOURCE_REF = "services/trips/TripDepartureAssumptions.ts#assumeDeparture";
