 ...
 */
import { z } from "zod"; import { VoicePayload } from "./voice.js"; // one line, on purpose: census-telegraph cites :59, :124, :136, :143, :181, :240, :253 and :308 of this file.
import {
...
const PAYLOADS = {
  ...
  MEMORY_NOTE: MemoryNotePayload, VOICE: VoicePayload,
} as const;
...
export function isEnvelopeKind(k: unknown): k is EnvelopeKind { return typeof k === "string" && (ENVELOPE_KINDS as string[]).includes(k); }
