...
router.post('/threads/:threadId/messages', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var auth, client, user, threadId, body, msgTypeRaw, msgType, subtype, membership, sc, senderProfile, senderLanguage, now, _a, msg, msgErr, m;
        ...
        switch (_k.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, sc
                        ...
                        .maybeSingle()];
            case 3:
                senderProfile = (_k.sent()).data;
                senderLanguage = (_f = (_e = senderProfile === null || senderProfile === void 0 ? void 0 : senderProfile.preferred_language) !== null && _e !== void 0 ? _e : senderProfile === null || senderProfile === void 0 ? void 0 : senderProfile.preferred_message_language) !== null && _f !== void 0 ? _f : 'en';
                now = new Date().toISOString();
                return [4 /*yield*/, sc
                        .from('messages')
                        ...
                        .single()];
            case 4:
                _a = _k.sent(), msg = _a.data, msgErr = _a.error;
                if (msgErr || !msg) {
                    req.log.error({ err: msgErr }, 'message insert failed');
                    (0, http_1.sendError)(res, 'db_error', (_g = msgErr === null || msgErr === void 0 ? void 0 : msgErr.message) !== null && _g !== void 0 ? _g : 'Failed to insert message');
                    return [2 /*return*/];
                }
            ...
            case 5:
                ...
                res.status(201).json({
                    ...
                    msgType: (_h = m.msg_type) !== null && _h !== void 0 ? _h : 'text',
                    subtype: (_j = m.subtype) !== null && _j !== void 0 ? _j : null,
                });
