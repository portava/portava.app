...
// `StoryRetentionDates` and `retentionDatesFor` live in
// services/stories/storyRetentionPolicy.ts, beside the windows they count
// with, because lib/mediaAccess.ts needs them too and a lib importing a
// route file is the wrong direction. Re-exported here so the archive's
// callers and its test keep one import site.
export { retentionDatesFor };
export type { StoryRetentionDates } from "../services/stories/storyRetentionPolicy.js";
