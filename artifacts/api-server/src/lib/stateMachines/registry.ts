    ...
    transitions: [
      {
        ...
        to: "planning",
        classification: "REACHABLE",
        writer: { file: "domain/trips/invariants/tripStatus.ts", evidence: ['return "planning";'] },
      },
      {
        from: ["planning", "upcoming", "active", "completed"],
        to: "draft",
        classification: "REACHABLE",
        writer: { file: "domain/trips/invariants/tripStatus.ts", evidence: ['if (!title || !destinationCity) return "draft";'] },
      },
      {
        from: ["draft", "planning", "active", "completed"],
        to: "upcoming",
        classification: "REACHABLE",
        writer: { file: "domain/trips/invariants/tripStatus.ts", evidence: ['if (today < start)        return "upcoming";'] },
      },
      {
        from: ["draft", "planning", "upcoming"],
        to: "active",
        classification: "REACHABLE",
        writer: { file: "domain/trips/invariants/tripStatus.ts", evidence: ['if (!end || today <= end) return "active";'] },
      },
      {
