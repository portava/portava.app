...
export type MediaKind = "image" | "video"; // The blank line that was here paid for the import above: four censuses cite this file by line number below, so the voice additions are net-zero above every one of them.
