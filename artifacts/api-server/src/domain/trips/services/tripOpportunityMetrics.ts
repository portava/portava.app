 ...
 * executable experience (domain/trips/projections/TripOpportunityProjection.ts);
 * accepted where POST /trips/:id/opportunities/:experienceId/accept writes
 * the plan through the kernel (server/trips/readRoutes/tripProjections.ts). Completed is
