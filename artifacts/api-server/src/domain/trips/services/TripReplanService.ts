 ...
 * shared by the routes (server/trips/readRoutes/tripProjections.ts) and the Compass tools
...
import { buildTripFreedomProjection } from "../projections/TripFreedomProjection.js";
import { buildTripPulseProjection } from "../projections/TripPulseProjection.js";
import { buildTripOpportunityProjection, straightLineEstimator } from "../projections/TripOpportunityProjection.js";
