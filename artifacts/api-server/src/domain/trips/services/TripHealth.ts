 ...
 * WHAT EXISTED
 * ============
 * census-trips TR314: `domain/trips/services/tripReadiness.ts`'s score plus a four-value
 ...
 */
import type { TemporalConflict } from "../invariants/TripFreedomEngine.js";
...
// declared in domain/trips/contracts/tripReasonCodes.ts since §38 and emitted from here.
