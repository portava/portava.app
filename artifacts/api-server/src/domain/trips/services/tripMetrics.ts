 ...
 * WHY THIS EXISTS
 * ===============
 * domain/trips/commands/tripKernel.ts keeps `trip_command_rejected_total` by reason as a private
 ...
 * (domain/trips/contracts/TripProjectionEnvelope.ts) — the §19.1 consumer rule — at
