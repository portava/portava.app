 ...
 * edit. The caller (server/trips/readRoutes/tripProjections.ts, Compass) shows the diff or
...
import type { TemporalConflict, FreedomWindow } from "../invariants/TripFreedomEngine.js";
