...
import { canSeePresence } from "../policies/tripPresencePolicy.js";
import { classifyPresence, type PresenceFreshnessClass, type PresenceConfidence } from "../policies/tripPresenceFreshness.js";
...
export interface RawMemberLocation {
  ...
  locationState: {
    ...
    source?: string | null;
    /** `user_location_state.accuracy_meters`. §10.1 `confidence`, banded by domain/trips/policies/tripPresenceFreshness.ts. */
...
export function buildCrewCard(
  ...
  // domain/trips/policies/tripPresencePolicy.ts and is tested as a rule against every actor
