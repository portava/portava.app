...
export interface QueueContext {
  ...
  now: number;
  /** The types the commands endpoint issues (server/trips/commandRoute.ts COMMANDS_ENDPOINT_TYPES). */
  issuable: ReadonlySet<string>;
  /** Cutover-gated types with their own route (server/trips/commandRoute.ts CUTOVER_GATED_TYPES). */
