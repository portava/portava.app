 ...
 */
import { computeFreedomWindows, detectPlanOverlaps, type FreedomWindow, type TemporalConflict } from "../invariants/TripFreedomEngine.js";
import { deriveTripHealth, prioritySwitch } from "../services/TripHealth.js";
import { projectSignals, type PulseInterpretation } from "../services/TripSignals.js";
import { evaluateRiskTriggers, type RiskTrigger } from "../services/TripRiskTriggers.js";
import { decisionUrgency } from "../services/TripDecisionUrgency.js";
import { replanDay, simulateChange } from "../services/TripReplan.js";
import { compileExperiences, type CompileResult, type ExecutableTripExperience } from "../services/TripExperienceCompiler.js";
import { attentionKindFor, diffOpportunities, shouldNotify, type OpportunityPortfolio } from "../services/TripOpportunityEngine.js";
import { findMeetingPoint } from "../services/TripMeetingPoint.js";
import { planRescue } from "../services/TripRescue.js";
import { decideAttention } from "../policies/TripAttentionPolicy.js";
import { unknownsFromExperiences, valueOfInformation } from "../services/TripValueOfInformation.js";
