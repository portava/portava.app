 ...
 * (seeded FALSE). Naming both flags in server/trips/readRoutes/tripMapProjection.ts would
 ...
 * `exactCoords` on it — which domain/trips/services/tripCrewLocation.ts does only under an
