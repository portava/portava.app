 ...
 * (domain/trips/services/tripCrewLocation.ts:226). This projection is the trip-scoped view §17.4
 ...
 */
import type { TripProjectionEnvelope } from "../contracts/TripProjectionEnvelope.js";
