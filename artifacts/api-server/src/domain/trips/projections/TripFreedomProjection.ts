 ...
 *
 * The travel term per hop comes from domain/trips/invariants/TripFeasibilityEngine.ts
...
import { recordDerivedEvents, type DerivedEventsReport } from "../events/tripDerivedEvents.js";
import {
