...
// entitled to publish — domain/trips/services/tripCrewLocation.ts puts `exactCoords` on a card
...
/** What this layer reads off a crew card — a subset of domain/trips/services/tripCrewLocation's CrewMemberCard. */
