 ...
 *
 * Every refusal carries an Appendix B reason (domain/trips/contracts/tripReasonCodes.ts), which is
...
import type { TripReasonCode } from "../contracts/tripReasonCodes.js";
...
// ── canSeePresence ───────────────────────────────────────────────────────────
// Pure, and in its own module (domain/trips/policies/tripPresencePolicy.ts) because
// domain/trips/services/tripCrewLocation.ts calls it for buildCrewCard's fork and this file
...
// Already built and graded C (census TR110): domain/trips/services/tripCrewLocation.ts
...
export { resolveExactCoords as canSeePreciseLocation } from "../services/tripCrewLocation.js";
