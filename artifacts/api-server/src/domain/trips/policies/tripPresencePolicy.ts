 ...
 * domain/trips/policies/tripPolicy.ts re-exports it as the §6.1 name, and domain/trips/services/tripCrewLocation.ts
...
/** The subject's presence-relevant state, as domain/trips/services/tripCrewLocation.ts assembles it. */
