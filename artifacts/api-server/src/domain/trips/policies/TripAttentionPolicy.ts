 ...
 *
 * Every trip push in this codebase goes through domain/trips/policies/tripPush.ts, which calls
 ...
 * Adding a push means adding a row here — domain/trips/policies/tripPush.ts refuses a kind it
