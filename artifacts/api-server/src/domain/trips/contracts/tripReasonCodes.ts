 ...
 *
 * This is the one list. domain/trips/commands/tripKernel.ts's TripKernelReason is a SUBSET of
...
import { sendError, type ApiErrorCode } from "../../../lib/http.js";
...
export const TRIP_REASON_CODES = [
  ...
  // ── TRIP_TEMPORAL_* ────────────────────────────────────────────────────────
  "TRIP_TEMPORAL_RANGE_INVERTED",     // 2420 / domain/trips/commands/tripKernel.ts
  ...
  // ── TRIP_PROJECTION_* ──────────────────────────────────────────────────────
  "TRIP_PROJECTION_UNAVAILABLE",      // domain/trips/contracts/tripDiscoveryProjection.ts
...
/**
 * The kernel's reasons that are NOT Appendix B families. domain/trips/commands/tripKernel.ts's
