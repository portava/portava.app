 ...
 * W: ONE projection (domain/trips/contracts/tripDiscoveryProjection.ts) carried all four, with
...
import { observeTripMetric } from "../services/tripMetrics.js";
 ...
 * domain/trips/services/tripMetrics.ts for why the consumer records it and not the producer.
 */
