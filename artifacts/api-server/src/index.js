...
var telegraphBroadcast_1 = require("./lib/telegraphBroadcast");
var safeReturnScheduler_1 = require("./lib/safeReturnScheduler");
...
app_1.default.listen(port, function (err) {
    ...
    (0, telegraphBroadcast_1.initTelegraphBroadcast)();
    (0, safeReturnScheduler_1.startSafeReturnScheduler)();
