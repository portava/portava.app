...
## 2026-08-28 — Messaging RLS: recursion, correlation, and a policy that granted what it meant to subtract (2197)

- `2197_messaging_rls_recursion_and_correlation.sql` — **NOT yet applied to CI or prod.** Three defects on the messaging read path, found while applying 2182. None was caused by 2182: no policy involved references any function 2182 relocated, and all three expressions are byte-identical in the 2026-08-19 baseline dump.
