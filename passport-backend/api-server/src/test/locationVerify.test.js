...
var locationVerify_ts_1 = require("../lib/locationVerify.ts");
...
(0, node_test_1.test)("haversine: same point is 0m", function () {
    strict_1.default.equal(Math.round((0, locationVerify_ts_1.calculateDistanceMeters)(CEBU.lat, CEBU.lng, CEBU.lat, CEBU.lng)), 0);
});
(0, node_test_1.test)("haversine: nearby points within ~300m", function () {
    var d = (0, locationVerify_ts_1.calculateDistanceMeters)(CEBU.lat, CEBU.lng, CEBU_NEAR.lat, CEBU_NEAR.lng);
...
(0, node_test_1.test)("haversine: Cebu->Manila is hundreds of km", function () {
    var d = (0, locationVerify_ts_1.calculateDistanceMeters)(CEBU.lat, CEBU.lng, MANILA.lat, MANILA.lng);
...
(0, node_test_1.test)("1. GPS within radius -> verified + stamp_eligible", function () {
    var _a;
    var r = (0, locationVerify_ts_1.verifyLocation)({
...
(0, node_test_1.test)("6. no location -> unavailable, NO stamp", function () {
    var r = (0, locationVerify_ts_1.verifyLocation)({ locationSource: "none" });
    strict_1.default.equal(r.stampEligible, false);
...
(0, node_test_1.test)("8. default threshold is ~1 mile", function () {
    strict_1.default.equal(locationVerify_ts_1.DEFAULT_THRESHOLD_METERS, 1609);
});
...
(0, node_test_1.test)("10. postcard created only with media + add_to_passport + active", function () {
    strict_1.default.equal((0, locationVerify_ts_1.shouldCreatePostcard)({ mediaUrls: ["x"], addToPassport: true, status: "active" }), true);
    strict_1.default.equal((0, locationVerify_ts_1.shouldCreatePostcard)({ mediaUrls: [], addToPassport: true, status: "active" }), false); // no media
    strict_1.default.equal((0, locationVerify_ts_1.shouldCreatePostcard)({ mediaUrls: ["x"], addToPassport: false, status: "active" }), false); // toggle off
    strict_1.default.equal((0, locationVerify_ts_1.shouldCreatePostcard)({ mediaUrls: ["x"], addToPassport: true, status: "hidden" }), false); // not active
});
