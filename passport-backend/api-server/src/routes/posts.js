...
router.post("/posts", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var auth, client, user, parsed, _a, content, mediaUrls, tripId, visibility, _b, mediaType, addToPassport, locationName, locationPlaceId, locationCity, locationCountry, locationLat, locationLng, userGpsLat, userGpsLng, locationSource, verdict, _c, data, error, postcard, pc;
    var _d, _e;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 5:
                ...
                postcard = null;
                if (!(0, locationVerify_1.shouldCreatePostcard)({ mediaUrls: mediaUrls !== null && mediaUrls !== void 0 ? mediaUrls : [], addToPassport: addToPassport !== null && addToPassport !== void 0 ? addToPassport : true, status: 'active' })) return [3 /*break*/, 7];
                return [4 /*yield*/, client
